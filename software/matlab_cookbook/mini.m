...
<html ="http://www.w3.org/1999/xhtml">
  ...
  (function() {
    ...
    <p>function [idx vals] =&nbsp;mini(mat)</p>
<p>% [<span class="caps">IDX</span> <span class="caps">VALS</span>] = <span class="caps">MINI</span>(<span class="caps">MAT</span>)
%
% Just calls Matlab&#8217;s built-in <span class="caps">MIN</span> function, but returns
% the <span class="caps">IDX</span>&nbsp;first.</p>
<p>[vals idx] =&nbsp;min(mat);</p>
          <br>
<hr>
