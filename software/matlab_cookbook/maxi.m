...
<html ="http://www.w3.org/1999/xhtml">
  ...
  (function() {
    ...
    <p>function [idx vals] =&nbsp;maxi(mat)</p>
<p>% [<span class="caps">IDX</span> <span class="caps">VALS</span>] = <span class="caps">MAXI</span>(<span class="caps">MAT</span>)
%
% Just calls Matlab&#8217;s built-in <span class="caps">MAX</span> function, but returns
% the <span class="caps">IDX</span>&nbsp;first.</p>
<p>[vals idx] =&nbsp;max(mat);</p>
          <br>
<hr>
