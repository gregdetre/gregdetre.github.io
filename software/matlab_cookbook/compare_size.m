...
<html ="http://www.w3.org/1999/xhtml">
  ...
  (function() {
    ...
    <p>function [issame] =&nbsp;compare_size(m1,m2)</p>
<p>% Returns true if two matrices are the same size
%
% [issame] = compare_size(m1,m2)
%
% Checks that M1 and M2 have the same number of dimensions and each
% dimension is the same&nbsp;size</p>
...
%&nbsp;information.</p>
<p>issame =&nbsp;true;</p>
<p>if ndims(m1) ~= ndims(m2)
  issame = false;
  return&nbsp;end</p>
<p>if ~all(size(m1)==size(m2))
  issame = false;
  return&nbsp;end</p>
          <br>
<hr>
